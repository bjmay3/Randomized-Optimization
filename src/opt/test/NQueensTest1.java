...
public class NQueensTest1 {
    ...
    public static void main(String[] args) {
        ...
        FixedIterationTrainer fit = new FixedIterationTrainer(rhc, 300);
        fit.train();
       ...
       // System.out.println(ef.boardPositions());
        ...
        fit = new FixedIterationTrainer(sa, 300);
        fit.train();
       ...
       // System.out.println(ef.boardPositions());
        ...
        fit = new FixedIterationTrainer(mimic, 300);
        fit.train();
